...
latex_documents = [(master_doc, _targetname, project, author, "howto")]
...
# -- docx Settings -----
# See: https://pypi.org/project/docxbuilder/

docx_documents = [
    (master_doc, f"{project_slug}.docx", {"title": project, "creator": author}, False),
]
...
html_theme_options = {"nosidebar": True, "relbarbgcolor": "black", "extra_navbar": None}
